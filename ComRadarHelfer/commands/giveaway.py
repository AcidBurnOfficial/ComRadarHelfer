...
from config import TEST_GUILD_ID, GIVEAWAY_CHANNEL_ID
...
class GiveawayModal(Modal, title="🎁 Neues Giveaway erstellen"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        logger.info(f"🎉 Giveaway gestartet von {interaction.user} (Preis: {self.preis.value})")
...
class GiveawayCog(commands.Cog):
    ...
    # /giveaway starten
    # -----------------------------------------
    @app_commands.command(name="giveaway", description="🎁 Starte ein neues Giveaway (Admin/Team only)")
    ...
    # -----------------------------------------
    # /reroll – mit Nachrichten-ID
    # -----------------------------------------
    @app_commands.command(name="reroll", description="♻️ Ziehe neue Gewinner für ein Giveaway per Nachrichten-ID.")
    ...
    # /cancel
    # -----------------------------------------
    @app_commands.command(name="cancel", description="🛑 Bricht das aktuelle Giveaway ab (per Nachrichten-ID).")
